...
<link rel="stylesheet" type="text/css" href="${path}/resources/js/common/bootstrap3.3.5/css/bootstrap-dialog.min.css" />

<link rel="stylesheet" type="text/css" href="${path}/resources/js/common/bootstrap3.3.5/css/bootstrap-datetimepicker.min.css" />
