...
<body>
	<div style="margin-top: 20px">
		...
		<form  id="registerForm" action="${path}/mng/register/userRegister" method="post">
		...
		<div class="form-group">
 		...
 		<!-- onclick="register()" -->
		<div style="margin-left: 500px;"><input class="btn btn-primary" type="submit" style="width: 150px" value="注册"></input><br/><a href="${path }/mng/index/login">已有账号，直接登录</a></div>
		</form>
	</div>
