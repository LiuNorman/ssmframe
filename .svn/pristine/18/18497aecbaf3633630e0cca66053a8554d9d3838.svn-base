 package com.function.pay.alipay.config;
 
 public class AlipayConfig{
	 
   private String partner = "2088702425956040";
 
   private String key = "khitfq4xpwybi97fx4foltqqtgbiftck";
 
   private String seller_email = "heroliuxiaowen@163.com";
